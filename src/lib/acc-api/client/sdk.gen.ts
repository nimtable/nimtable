...
import type { LoginData, LoginResponse2, LoginError, LogoutData, LogoutResponse2, LogoutError, ResetPasswordData, ResetPasswordResponse, ResetPasswordError, GetCurrentUserProfileData, GetCurrentUserProfileResponse, GetCurrentUserProfileError, UpdateCurrentUserProfileData, UpdateCurrentUserProfileResponse, UpdateCurrentUserProfileError, GetUsersData, GetUsersResponse, GetUsersError, CreateUserData, CreateUserResponse, CreateUserError, DeleteUserData, DeleteUserResponse, DeleteUserError, GetUserByIdData, GetUserByIdResponse, GetUserByIdError, UpdateUserData, UpdateUserResponse, UpdateUserError } from './types.gen';
...
export const resetPassword = <ThrowOnError extends boolean = false>(options: Options<ResetPasswordData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ResetPasswordResponse, ResetPasswordError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
