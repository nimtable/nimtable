                ...
                <main className="flex-1 p-8 overflow-auto">
                    <div className="mx-auto max-w-3xl flex flex-col items-center justify-center h-full py-12">
                        <div className="relative mb-8">
                            <div className="text-[10rem] font-bold text-blue-600/10 leading-none select-none">404</div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl mb-12">
                            <div className="bg-white dark:bg-gray-950 rounded-lg border p-6 shadow-sm flex flex-col items-center text-center">
                                ...
                                <p className="text-sm text-muted-foreground mb-4">Go back to the main dashboard to select a catalog</p>
                            ...
                            <div className="bg-white dark:bg-gray-950 rounded-lg border p-6 shadow-sm flex flex-col items-center text-center">
                                ...
                                <p className="text-sm text-muted-foreground mb-4">Select a catalog from the sidebar to browse tables</p>
                                <Button
                                    variant="outline"
                                    className="mt-auto"
                                    onClick={() => {
                                        // This will just focus on the sidebar dropdown
                                        const dropdown = document.querySelector("[data-radix-select-trigger]")
