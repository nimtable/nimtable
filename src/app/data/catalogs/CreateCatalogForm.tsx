      ...
      {isInputPhase ? (
        <div className="space-y-2">
          <Label htmlFor="textInput">
            Paste Configuration ({CATALOG_TEMPLATES[selectedTemplateKey]?.name})
          </Label>
          <Textarea
            id="textInput"
            name="textInput"
            ...
            placeholder={
              CATALOG_TEMPLATES[selectedTemplateKey]?.inputPlaceholder ??
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      For Glue catalog, ensure AWS credentials (AWS_REGION,
                      AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY) are configured
                      in the environment or Docker setup.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    ...
                    <p className="mt-2">
                      ...
                      >
                        View AWS S3 Tables Integration Documentation →
                      </a>
                    </p>
                  </div>
                </div>
