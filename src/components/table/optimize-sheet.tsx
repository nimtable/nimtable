                    ...
                    <div className="space-y-4 pt-2 border-t">
                      ...
                      {orphanFileDeletion && (
                        <div className="grid gap-2 pl-4 pt-2">
                          <Label htmlFor="orphan-retention">
                            Delete orphan files after (days)
                          </Label>
                          <Input
                            id="orphan-retention"
                            type="number"
                            ...
                            onChange={(e) =>
                              setOrphanFileRetention(e.target.value)
                            }
                            placeholder="3"
                            className="border-muted-foreground/20"
                          />
                    ...
                    {step.status === "done" && step.result && (
                      <div className="text-sm text-muted-foreground">
                        ...
                        {step.name === "Orphan File Cleanup" &&
                          step.result?.orphanFileLocations != null && (
                            <>
                              Cleaned: {step.result.orphanFileLocations.length}{" "}
                              orphan files
                            </>
                          )}
                      </div>
