...
public class ManifestServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try (FileIO fileIO = table.io()) {
      ...
      if (manifestNumber == null) {
        ...
        if (manifest == null) {
          response.sendError(
              HttpServletResponse.SC_NOT_FOUND, "Invalid manifest number: " + manifestNumber);
          return;
        }
  ...
  private ObjectNode dataFileToJson(DataFile file) {
    ...
    if (file.lowerBounds() != null) {
      ...
      file.lowerBounds()
          .forEach((key, value) -> lowerBoundsNode.put(key.toString(), formatBinary(value)));
    ...
    if (file.upperBounds() != null) {
      ...
      file.upperBounds()
          .forEach((key, value) -> upperBoundsNode.put(key.toString(), formatBinary(value)));
