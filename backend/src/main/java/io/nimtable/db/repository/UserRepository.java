 ...
 * Uses plain JDBC and PersistenceManager for connection handling.
 */
public class UserRepository {
     ...
     *
     * @param user The user object to create. The ID field is ignored and will be
     *             generated.
     *             Requires `username` and `passwordHash` to be set.
     * @return The created user with the generated ID and timestamps populated.
     * @throws SQLException if a database access error occurs or the user could not
     *                      be created.
     */
     ...
     *         found.
     *         Logs an error if a SQLException occurs during the query.
     */
     ...
     * @return An Optional containing the found User, or an empty Optional if not
     *         found or username is null/empty.
     *         Logs an error if a SQLException occurs during the query.
     */
     ...
     *
     * @param user The user object containing the updated information. The ID field
     *             must be set.
     *             Requires `username` and `passwordHash` to be set with the desired
     *             values.
     * @return true if the user was found and updated successfully, false otherwise
     *         (e.g., user not found).
     * @throws SQLException             if a database access error occurs (e.g.,
     ...
     * @return true if the user was found and deleted successfully, false otherwise
     *         (e.g., user not found).
     ...
     * @throws SQLException if a column is not found or a database access error
     *                      occurs.
     */
